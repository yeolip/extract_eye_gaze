...
cap3 = cv2.VideoCapture("D:/Project/CVT/발표/result/3d_gaze_roi_result_14.mp4")
# cap = cv2.VideoCapture("D:/Project/CVT/발표/result/1_cto_DRCAM_KOR40BU4578_20190219_114431_0002.mp4")
...
while True:
    ...
    img3 = cv2.resize(image3, (640+200,482+150))
    cv2.putText(img1, 'origin_mov', #.format(tfps, "      "),
                (10, 30),
                cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), thickness=2, lineType=8)

    cv2.putText(img2, 'virtual_gaze_roi (view - back to front)', #.format(tfps, "      "),
                (10, 30),
                cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), thickness=2, lineType=8)

    cv2.putText(img3, 'virtual_gaze_roi (view - up to down)', #.format(tfps, "      "),
                (10, 30),
                cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), thickness=2, lineType=8)

    # cv2.imshow('origin vs virtual', cv2.hconcat([img1,img2]))
    objsave_mov.write(cv2.hconcat([img1,img2,img3]))
